...
class Subscription(models.Model):
    ...
    plan = models.ForeignKey(Plan, on_delete=models.CASCADE, verbose_name="Тарифный план")
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, verbose_name="Статус подписки")
...
class Payment(models.Model):
    ...
    yk_payment_method_id = models.CharField(max_length=255, verbose_name="ID способа оплаты в ЮKassa", blank=True, null=True)
    user_uuid = models.UUIDField(verbose_name="UUID пользователя")
